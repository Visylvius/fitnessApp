...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var GetField = __webpack_require__(160);
	...
	var App = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    axios.get('http://localhost:8080/people').then(function (resp) {
	  ...
	  updateUser: function updateUser() {
	    axios.put('http://localhost:8080/people/' + this.state.selectedUser.id, this.state.selectedUser).then(function (resp) {
	    ...
	    if (this.state.selectedUser === null) {
	      return React.createElement(
	        ...
	        this.state.users.map(function (user) {
	          return React.createElement(
	            'option',
	            { value: user.id, key: user.userName },
	            user.firstName,
	            ' ',
	            user.lastName
	          );
	      ...
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(GetField, { changeCallBack: this.handleChange, value: this.state.selectedUser.firstName, field: 'firstName', placeholder: 'enter first name' }),
	        React.createElement(GetField, { changeCallBack: this.handleChange, value: this.state.selectedUser.lastName, field: 'lastName', placeholder: 'enter last name' }),
	        React.createElement(GetField, { changeCallBack: this.handleChange, value: this.state.selectedUser.userName, field: 'userName', placeholder: 'enter user name' }),
	        React.createElement(
	          'button',
